...
<div>
  ...
  <div className="flex flex-col gap-2 mt-6">
          ...
          <input type="text" name="" placeholder='Enter Username' className='shadow-xl p-4 lg:py-1 py-1 lg:p-12 text-left rounded-md' id="" />
          <input type="email" name="" placeholder='Email' className='shadow-xl p-4 lg:py-1 lg:p-12 py-1  rounded-md' id="" />
          </div>
          <div className="flex flex-col lg:flex-row gap-3 items-center w-full pb-4 text-black  ">
            <input type="password" name="" placeholder='Password' id="" className='shadow-xl p-4 lg:py-1 py-1 lg:p-12 text-black   rounded-md' />
  ...
  <div class="relative text-black text-left">
    ...
    <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
      {/* <!-- Dropdown arrow --> */}
      <svg class="h-6 w-6 absolute right-9 lg:left-64 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
